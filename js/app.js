...
var app = new Vue({
  ...
  data: {
    ...
    // boroughs
    {
      ...
      groupDisplayName: 'City of London',
      navGroup: 'boroughs',
      navGroupOrder: 0,
      active: false,
      layers: [{
        ...
        z: 5,
        url: 'https://gis.london.gov.uk/arcgis/rest/services/apps/planning_blp_data/MapServer/',
        appendIDtoURL: true,
        active: false,
        swatches: ['#6da7de', '#9e0059', '#dee000', '#d82222', '#5ea15d', '#943fa6', '#666666'],
        color: '#666666',
        opacity: 1,
        userControl: true,
        popup: '<p><strong>{designation}:</strong><br>{sitename}</p>',
      ...
      groupDisplayName: 'Barking and Dagenham',
      navGroup: 'boroughs',
      navGroupOrder: 0,
      active: false,
      layers: [{
      ...
      groupDisplayName: 'Hammersmith and Fulham',
      navGroup: 'boroughs',
      navGroupOrder: 0,
      active: false,
      layers: [{
      ...
      groupDisplayName: 'Kensington and Chelsea',
      navGroup: 'boroughs',
      navGroupOrder: 0,
      active: false,
      layers: [{
      ...
      groupDisplayName: 'Tower Hamlets',
      navGroup: 'boroughs',
      navGroupOrder: 0,
      active: false,
      layers: [{
      ...
      groupDisplayName: 'Waltham Forest',
      navGroup: 'boroughs',
      navGroupOrder: 0,
      active: false,
      layers: [{
